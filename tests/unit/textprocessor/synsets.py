...
from core.textprocessor import synsets


class SynsetTestCase(unittest.TestCase):
    @patch('core.textprocessor.synsets.generate_window',
    ...
    def test_synsets_without_none(self):
        ...
        s = synsets.get_synsets(tokens, 4)
...
class WindowTestCase(unittest.TestCase):
    def test_valid_window(self):
        ...
        expected_window = 4
        window = synsets.validate_window(expected_window)
        self.assertEqual(window, expected_window)

    def test_invalid_window(self):
        expected_window = 4
        window = synsets.validate_window(1)
        self.assertEqual(window, expected_window)
